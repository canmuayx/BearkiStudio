...
function Library:create(options)
	...
	creditsTab:credit{Name = "Abstract", Description = "UI Library Developer", Discord = "jds.cxn_n", V3rmillion = "AbstractPoo"}
	creditsTab:credit{Name = "Deity", Description = "UI Library Developer", Discord = "jds.cxn_n", V3rmillion = "0xDEITY"}
	creditsTab:credit{Name = "Repository", Description = "UI Library Repository", Github="jds.cxn_n"}
